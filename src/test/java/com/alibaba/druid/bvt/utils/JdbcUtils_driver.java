...
public class JdbcUtils_driver extends TestCase {
    ...
    public void test_null() throws Exception {
        Assert.assertNull(WallDenyStat.JdbcUtils.getDriverClassName(null));
    }

    public void test_driver() throws Exception {
        String url = "jdbc:odps:xxx";
        String className = WallDenyStat.JdbcUtils.getDriverClassName(url);
        ...
        Assert.assertEquals(JdbcConstants.ODPS, WallDenyStat.JdbcUtils.getDbType(url, className));
    }

    public void test_log4jdbc_mysql() {
        String jdbcUrl = "jdbc:log4jdbc:mysql://localhost:8066/test";
        String dbType = WallDenyStat.JdbcUtils.getDbType(jdbcUrl, null);
    ...
    public void test_log4jdbc_mysql2() throws Exception {
        String jdbcUrl = "jdbc:log4jdbc:mysql://localhost:8066/test";
        String dbType = WallDenyStat.JdbcUtils.getDbType(jdbcUrl, "net.sf.log4jdbc.DriverSpy");
        assertEquals("not support log4jdbc mysql, url like jdbc:log4jdbc:mysql:...", JdbcConstants.MYSQL, dbType);
    }
    ...
    public void test_log4jdbc_derby() throws Exception {
        ...
        String dbType = WallDenyStat.JdbcUtils.getDbType(jdbcUrl, "net.sf.log4jdbc.sql.jdbcapi.DriverSpy");
    ...
    public void test_log4jdbc_es() throws Exception {
        assertEquals(JdbcConstants.ELASTIC_SEARCH
                , WallDenyStat.JdbcUtils.getDbType("jdbc:elastic://100.69.202.4:9300/tcbuyer?cluster.name=refund_cluster", null));
    }

    public void test_log4jdbc_es_1() throws Exception {
        assertEquals(JdbcConstants.ELASTIC_SEARCH
                , WallDenyStat.JdbcUtils.getDbType("jdbc:elastic://100.69.202.4:9300/tcbuyer?cluster.name=refund_cluster", "com.alibaba.xdriver.elastic.jdbc.ElasticDriver"));
    }

    public void test_log4jdbc_es_driver() throws Exception {
        assertEquals(JdbcConstants.ELASTIC_SEARCH_DRIVER
                , WallDenyStat.JdbcUtils.getDriverClassName("jdbc:elastic://100.69.202.4:9300/tcbuyer?cluster.name=refund_cluster"));
    }
}
